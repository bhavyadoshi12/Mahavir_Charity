...
$sqlmember = "SELECT member.*,member_type.member_type FROM member LEFT JOIN member_type ON member.member_type_id=member_type.member_type_id WHERE member.member_id='$_GET[member_id]'";
...
<div class="col-md-9">
	<div class="widget">
		...
		<hr>
		<h3 class="widget-title">Application form to Adopt <?php echo $rsmember['name']; ?></h3>
		<div class="widget-category">
<?php
...
?>
	<a href="" class="btn btn-info" onclick="return false;" data-toggle="modal" data-target="#DonorLoginModal">Login to Donor</a>
<?php
	}
}
?>
