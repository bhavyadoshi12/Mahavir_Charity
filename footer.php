			...
			<div class="col-md-4">
				<div class="footer">
					<div class="footer-logo">
						<a class="logo" href="#"><img src="img/logo 02.png" alt=""></a>
					</div>
					<p>Mahavir Charity is the non-profit organization which helps old people, poor people, Mentally challenging peoples which is situated in Assaigoli, Konaje, Bangalore.</p>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="footer">
					...
					<ul class="footer-contact">
						<li><i class="fa fa-map-marker"></i> Mahavir Charity,<br> &nbsp;&nbsp;&nbsp; Opp. Bhandup police station,<br> &nbsp;&nbsp;&nbsp; Mumbai -400078</li>
						<li><i class="fa fa-phone"></i> +91-9619903912 </li>
						<li><i class="fa fa-envelope"></i> <a href="#"><span >mahavircharity@gmail.com</span></a></li>
					</ul>
		...
		<div id="footer-bottom" class="row">
			...
			<div class="col-md-6 col-md-pull-6">
				<div class="footer-copyright">
					<span>
						Copyright &copy Bhavya Ketan Doshi
					</span>
				</div>
			</div>
		</div>
