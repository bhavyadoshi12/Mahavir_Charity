...
function validateform()
{
	...
	{
		document.getElementById("errappointment_title").innerHTML = "Title should not be empty..";
		i=1;
	}
	if(document.getElementById("reason_for_appoinment").value == "")
	{
		document.getElementById("errreason_for_appoinment").innerHTML = "Reason should not be empty..";
		i=1;
	}
	if(document.getElementById("appointment_date").value == "")
	{
		document.getElementById("errappointment_date").innerHTML = "Date should not be empty..";
		i=1;
	}
	if(document.getElementById("appointment_time").value == "")
	{
		document.getElementById("errappointment_time").innerHTML = "Time should not be empty..";
		i=1;
	}
	if(i == 0)
	{
